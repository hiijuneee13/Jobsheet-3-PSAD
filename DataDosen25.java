public class DataDosen25 {
    void dataSemuaDosen(Dosen25[] arrayDosen) {
    ...
    void jumlahDosenSetiapJenisKelamin(Dosen25[] arrayDosen) {
        int pria = 0;
        int wanita = 0;
    ...
    void rataRataUsiaDosen(Dosen25[] arrayDosen) {
        int totalUsiaPria = 0;
        int jumlahPria = 0;
    ...
    void dosenPalingTua(Dosen25[] arrayDosen) {
        int tertua = 0;
    ...
    void dosenPalingMuda(Dosen25[] arrayDosen) {
        int termuda = 0;
